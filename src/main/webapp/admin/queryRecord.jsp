...
<head>
    ...
    <script type="text/javascript">
        function exp() {
            ...
            window.location.href = "/employee/AdminHandler/export?name=" + name + "&s_date=" + s_date + "&e_date=" + e_date;
        }
        ...
        function pri() {
            ...
            var s_date = document.getElementById("s_date").value;
            var e_date = document.getElementById("e_date").value;
            window.open("/employee/AdminHandler/print?name=" + name + "&s_date=" + s_date + "&e_date=" + e_date, "_blank");
        }
    </script>
</head>
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <h5>勤怠管理システム</h5>
            <form name="recordquery" action="/employee/AdminHandler/queryRec/1" method="get">
                <div class="row">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-3 pos">
                        ...
                        <input type="button" id="print" class="btn btn-primary"
                               style="margin-left: 217px;margin-bottom: 0px;margin-top: -76px;" value="プリント" disabled
                               onclick="pri()"/>
                    </div>
                </div>
            </form>
                            ...
                            <c:forEach var="record" items="${requestScope.rlist}" varStatus="xh">
                                <tr>
                                    ...
                                    <td><a class="btn btn-default"
                                           href="/employee/AdminHandler/modityRec/${record.id}">
                                        修正 </a></td>
                                </tr>
    ...
    <div class="col-md-6">
        <nav aria-label="Page navigation">
            <ul class="pagination bg-primary">
                <li>
                    <a href="/employee/AdminHandler/queryRec/1?name=${requestScope.name}&s_date=${requestScope.s_date}&e_date=${requestScope.e_date}">トップページ</a>
                </li>
                <c:if test="${pageInfo.hasPreviousPage }">
                    <li>
                        <a href="/employee/AdminHandler/queryRec/${pageInfo.pageNum-1}?name=${requestScope.name}&s_date=${requestScope.s_date}&e_date=${requestScope.e_date}"
                ...
                <c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
                    ...
                    <c:if test="${page_Num != pageInfo.pageNum }">
                        <li>
                            <a href="/employee/AdminHandler/queryRec/${page_Num }?name=${requestScope.name}&s_date=${requestScope.s_date}&e_date=${requestScope.e_date}">${page_Num }</a>
                        </li>
                    </c:if>
                ...
                <li>
                    <a href="/employee/AdminHandler/queryRec/${pageInfo.pages}?name=${requestScope.name}&s_date=${requestScope.s_date}&e_date=${requestScope.e_date}">最後のページ</a>
                </li>
            </ul>
        </nav>
    </div>
